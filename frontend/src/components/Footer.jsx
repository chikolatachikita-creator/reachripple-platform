      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-1 sm:gap-x-2 gap-y-1">
            ...
            <Link to="/online-safety" className="text-sm text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors px-2.5 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800">Safety</Link>
