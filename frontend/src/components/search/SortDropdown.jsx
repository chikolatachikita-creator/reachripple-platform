  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="text-sm font-medium text-zinc-700 bg-white border border-zinc-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-pink-500 focus:border-pink-500 cursor-pointer hover:border-pink-400 transition-colors"
      >
        {options.map((opt) => (
